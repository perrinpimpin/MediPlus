 ...
 * @author CRISTANTE
 */
public class AfficherDMUrgence extends javax.swing.JFrame {
    ...
    public AfficherDMUrgence(DM dm) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherDMUrgence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
