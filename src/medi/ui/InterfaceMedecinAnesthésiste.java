 ...
 * @author CRISTANTE
 */
public class InterfaceMedecinAnesthésiste extends javax.swing.JFrame {
    ...
    public InterfaceMedecinAnesthésiste(Medecin m) {
        initComponents();
        connect = new BD();
        this.m = m;
        ...
        try {
            ...
            Logger.getLogger(InterfaceMedecinAnesthésiste.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        AfficherDMAnesthésiste addm = new AfficherDMAnesthésiste(dm);
        addm.setVisible(true);
    }//GEN-LAST:event_jButton16ActionPerformed

    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        EditerDMAnesthésiste edm = new EditerDMAnesthésiste(dm, m);
        edm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceMedecinAnesthésiste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
