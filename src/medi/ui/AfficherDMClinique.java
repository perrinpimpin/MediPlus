 ...
 * @author CRISTANTE
 */
public class AfficherDMClinique extends javax.swing.JFrame {
    ...
    public AfficherDMClinique(DM dm) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherDMClinique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
