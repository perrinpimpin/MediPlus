 ...
 * @author CRISTANTE
 */
public class AfficherDMMT extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherDMMT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
